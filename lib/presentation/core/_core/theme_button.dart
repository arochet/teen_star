...
ButtonStyle buttonBig(Color color, bool isWhite) => ElevatedButton.styleFrom(
    textStyle: TextStyle(fontFamily: 'MyriadPro', fontSize: 18.0, fontWeight: FontWeight.bold),
...
ButtonStyle buttonLittle(Color color, bool isWhite) => ElevatedButton.styleFrom(
      textStyle: TextStyle(fontFamily: 'MyriadPro', fontSize: 12.0, fontWeight: FontWeight.bold),
