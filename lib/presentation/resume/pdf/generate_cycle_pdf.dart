...
Widget header(Context context) {
  final TextStyle styleMain = TextStyle(fontWeight: FontWeight.bold, color: PdfColors.orange, fontSize: 16);
  final TextStyle styleSecond = TextStyle(fontWeight: FontWeight.bold, fontSize: 14);
  ...
  return Table(
    ...
    children: [
      TableRow(
        ...
        children: title
            .map<Widget>((Cell t) => Expanded(child: PaddedHeader(context, t.label), flex: t.flex))
            .toList(),
      ),
      ...data.map(
        (List row) => TableRow(
